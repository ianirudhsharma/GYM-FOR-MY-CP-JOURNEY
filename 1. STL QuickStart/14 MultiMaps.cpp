...
//remember multimap[3]=11  inserting this way is not allowed as here it get confused to add or update
// so always use insert(make_pair(3,11));
// and update using pointers only